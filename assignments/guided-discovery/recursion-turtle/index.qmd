...
Here's another one. The first command makes the turtle move more quickly. 
...
Here's my output from this command:
...
If you were able to draw several trees, then great job! You've done enough to earn full participation credit in this Guided Discovery activity. If you've gotten that far and want to do more, I have some challenges for you!
