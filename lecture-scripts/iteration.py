...
for i in range(length):
    print("The character in index " + str(i) + " of the string is " + s[i] + ".")
...
total = 0
for i in range(11):
    total = total + i # can also be written total += i
print(total)
...
# print all even numbers through 10
for i in range(11):
    if i % 2 == 0:
        print(i)
...
i = 0
while i < 5:  # i < 5 is a Boolean statement that can be either True or False
    print(i)
    i = i + 1 # this is the line that ensures that we always eventually stop
...
for i in range(10):
    # skip everything else in this iteration if i % 3 == 0
    if i % 3 == 0:
        continue 
    print(i)
