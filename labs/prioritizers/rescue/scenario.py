...
from rescue.person import Person
from rescue.person import create_random_person
...
def create_random_scenario(loc1people=None, loc2people=None, 
  youInLoc1=None, trespassing=None, sameNum=True, min1 = 1, min2 = 1, max1 = 1, max2 = 1):
  ...
  numLoc2 = random.randint(min2, max2)
  ...
  if not sameNum:
    numLoc1 = random.randint(min1, max1)
  else:
    numLoc1 = numLoc2
