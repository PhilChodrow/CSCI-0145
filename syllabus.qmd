...
See the [complete schedule](schedule.qmd) for more details! 
...
[:Details.](#x-reading-quiz-details)

#### :x Reading Quiz Details
...
[:We can help you borrow a laptop if you need it](#x-borrowing-a-laptop)

#### :x Borrowing a Laptop
...
[:Details](#x-due-date-adjustment-details)

#### :x Due Date Adjustment Details
