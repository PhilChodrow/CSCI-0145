...
<table>
    ...
    <tr>
        <td class="syllabus-description-table-header">
            <b> Peer Help Sessions </b>
        </td>
        <td>
            Tuesdays, time TBD <br>
            Wednesdays, time TBD <br>
            Thursdays, time TBD <br>
            Sundays, time TBD
        </td>
    </tr>
    <tr>
        ...
        <td class="syllabus-description-table-entry">
            ...
            <br> <br> 
            Generally speaking, you should only email me if you need to talk about something personal or sensitive. Questions about course content should usually be asked on [Campuswire](tools.qmd#help-forum-campuswire). 
            <br> <br> 
            Student Hours are *your time* to come chat with me about course content. **I want to see you in Student Hours**. Yes, **you**. 
            <br> <br> 
            Peer help sessions (also often called tutoring) are time for you to work with your classmates with help and support from experienced CS students. There are help sessions in the evenings, four days a week. **Help sessions are recommended for everyone**. 
            <br> <br> 
            I expect you to [prepare to ask for help](help.qmd) when approaching me, your tutors, and your fellow students. 
            <br> <br> 
            ...
            <br> <br> 
            [You are expected to wear a mask](#masks) during class time and student hours. 
        </td>
    </tr>
</table>
...
### Masks Are Expected in CSCI 0145 {#masks}
...
1. **Do not attend class in person**. Isolate per College [policies](https://www.middlebury.edu/office/covid-19-updates/middlebury-college-main-campus/campus-guide/essential-health-and-safety-measures-8). We have relatively detailed lecture notes and other resources that will help you catch up with lecture content. Lecture periods will be partially recorded (I have limited ability to have the camera capture writing on the board). 
